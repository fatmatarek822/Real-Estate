          ...
          body: Padding(
            ...
            child: SingleChildScrollView(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    if(state is UploadNewPostLoadingState)
                      const LinearProgressIndicator(),
                    if(state is UploadNewPostLoadingState)
                      const SizedBox(
                        height: 10,
                        ...
                        children: [
                          ...
                          Stack(
                            ...
                            children: const [
                              ...
                              // if(AppCubit.get(context).imageFileList !=null)
                              //   CircleAvatar(child:
                              //   IconButton(icon: Icon(Icons.close),
                              //     onPressed: ()
                              //     {
                          ...
                          Container(
                            ...
                            child: GridView.builder(
                                itemCount: AppCubit.get(context).postImage,
                                gridDelegate:
                      ...
                      onPressed: ()
                      {
                        if(formKey.currentState!.validate())
                        {
                           AppCubit.get(context).UploadNewPost(
                            ...
                            //   no_of_bathroom: no_of_bathroomController.text,
                            //   area: AreaController.text,
                            //   postImage: AppCubit.get(context).postimage,
