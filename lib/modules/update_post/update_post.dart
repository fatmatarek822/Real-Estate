...
//       {
//         var postMosel = AppCubit.get(context).postModel;
//
//         NamePostController.text = postMosel!.namePost!;
//         DescriptionController.text = postMosel.description!;
//         PlaceController.text = postMosel.place!;
//         no_of_roomsController.text = postMosel.no_of_room!;
//         no_of_bathroomController.text = postMosel.no_of_bathroom!;
//         AreaController.text = postMosel.area!;
//       //  PriceController.text = postMosel.price!;
//
//
//         return Scaffold(
//           appBar: AppBar(),
